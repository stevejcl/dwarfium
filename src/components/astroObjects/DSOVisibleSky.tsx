            ...
            <div className="row mb-3">
                ...
                <div className="col-lg-5 col-md-9 col-sm-8 col-12">
                    <div className="tooltip-container">
                        ...
                        />
                        <span className="tooltip-text-SK">Enter the sky limit value.
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ac nisl magna. Quisque iaculis massa ac diam facilisis tempor. Sed.
                        </span>
                    </div>
                </div>
            </div>
