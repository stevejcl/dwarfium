...
const translations = {
  ...
  pIndexClaimer:
    "Ce site web et l'API Dwarf sont en phase bêta. L'API n'a pas été officiellement publiée et ne dispose pas de toutes les fonctionnalités de l'application mobile. Par conséquent, cette application propose une liste de fonctionnalités très limitée. Utilisez cette application uniquement si vous êtes à l'aise avec le fait de tester des logiciels bêta.",
  pIndexBugsHeader: "Bugs :",
  pIndexBug1:
    "L'URL de date interne du Dwarf II ne fonctionne pas dans le navigateur en raison de CORS (http://DWARF_IP:8092/date?date=).",
  pIndexBug2:
    "Pour le faire fonctionner, vous avez besoin du plugin CORS : Access-Control-Allow-Origin sur Chrome.",
  pIndexBug3:
    "Restriction : comme ce site web utilise uniquement le mode http pour communiquer avec le Dwarf, il ne peut pas détecter votre emplacement.",
  pCalendarTitle: "Calendrier Astronomique des Événements Célestes",
  pCalendarYear: "Année Calendaire",
  pAbout: "À Propos de",
  pAboutInfo:
    "Le projet a été lancé par Wai-Yin Kwan avec l'aide de JC LESAINT. Ce site web est un projet secondaire visant à combiner leur intérêt pour la programmation, l'astronomie et l'API de Dwarf II. Pour signaler des bugs ou voir le code original, visitez son ",
  ...
  pAboutDataCreditDSOAuth:
    "Le Dr. Michael Camilleri, de la Société Astronomique d'Auckland, Nouvelle-Zélande, a fourni les noms et tailles des objets pour les DSO qui ont 15 minutes d'arc ou plus.",
  ...
  pAboutDataCreditJuypterText:
    "dans le dépôt Github montre les étapes que j'ai suivies pour transformer les données brutes en listes d'objets.",
  ...
  pAboutAdditional: "Sources de Données Additionnelles",
