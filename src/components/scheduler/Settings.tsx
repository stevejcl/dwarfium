...
const SETTINGS_FIELDS: Array<[string, keyof SettingsData | string]> = [
    ...
    ["Help", "Use to Connect to Stellarium, leave blank if you are using default config"],
    ["Stellarium IP", "stellarium_ip"],
    ["Stellarium Port", "stellarium_port"],
    ["Help", "The following values are the default values used in the Create Session Tabs"],
    ["Exposure", "exposure"],
    ["Gain", "gain"],
    [
        "Help IR Cut",
