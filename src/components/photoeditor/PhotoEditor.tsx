...
const PhotoEditor: React.FC<PhotoEditorProps> = ({ thumbnailUrl, onClose, fullImageUrl: initialFullImageUrl }) => {
    ...
    const denoiseWithAI = async () => {
        ...
        const outputData = outputTensor.squeeze().mul(tf.scalar(255)).clipByValue(0, 255);
        ...
        const pixelArray = new Uint8ClampedArray(newCanvas.width * newCanvas.height * 4);
        ...
        const outputImageData = new ImageData(pixelArray, newCanvas.width, newCanvas.height);
        ...
        <div className="photo-editor-overlay">
            <div className="photo-editor-modal">
                ...
                <div className="photo-editor-header">
                    <h2>Bewerk Foto</h2>
                    <button className="photo-editor-close-btn" onClick={onClose}>Sluiten</button>
                </div>
                ...
                <div className="photo-editor-body">
                    ...
                    <div className="photo-editor-content">
                        <h4>Thumbnail</h4>
                        <img src={thumbnailUrl} alt="Thumbnail" className="photo-editor-thumbnail" />
                        ...
                        <div style={{ position: "relative", display: "inline-block" }}>
                            <img
                                ...
                                style={{
                                    filter: `${filter} brightness(${brightness}%) contrast(${contrast}%) saturate(${saturation}%) hue-rotate(${temperature}deg) drop-shadow(0px 0px ${sharpness / 10}px black)`,
                                }}
                            />
                    ...
                    <div className="photo-editor-sidebar">
                        ...
                        <input type="range" min="0" max="200" value={sharpness}
                        ...
                        {/* Filters */}
                        <h4>Filters</h4>
                        <button onClick={() => applyFilter("grayscale(100%)")}>Zwart-Wit</button>
                ...
                <div className="photo-editor-footer-container">
                    ...
                    <div className="photo-editor-footer">
                        <button onClick={saveImage} className="photo-editor-save-btn">Opslaan</button>
                    </div>
                    <button
                        onClick={() => {
