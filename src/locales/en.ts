...
const translations = {
  ...
  cPolarAlignProcess: "Processing Camera Polar Alignment: ",
  cPolarAlignAction: "Camera Polar Alignment",
  cPolarAlignTo90: "Camera Turn to 90°",
  cPolarAlignInitial: "Camera to Initial Pos.",
  cPolarAlignTurnDownLens: "Lens turn Down",
  cLensTurnDownProcess: "Processing Lens turn Down",
  cLensAlignProcess: "Processing Camera Alignment: ",
  cMotorResetProcess: "Reseting Motor Position",
  cMotorResetAction: "Reset Motor Position",
  cMotorActionShow: "Show Motor Action",
  cMotorActionHide: "Hide Motor Action",
  cNavHome: "Home",
  cNavSetup: "Setup",
  cNavObjects: "Objects",
  cNavCamera: "Camera",
