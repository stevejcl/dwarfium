        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light">
                <div className="container">
                    ...
                    <a href="https://github.com/stevejcl/dwarfium" className="github-corner" aria-label="View source on GitHub" target="_blank" rel="noopener noreferrer">
                        <svg width="60" height="60" viewBox="0 0 250 250" style={{ fill: "#FD6C6C", color: "#fff", position: "absolute", top: 0, border: 0, right: 0 }} aria-hidden="true">
