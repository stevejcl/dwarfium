        ...
        var element_div_size = "725px";      // for height and width
        ...
        function createRowDiv(rownum) {
            ...
            row.className = "flex-containermosaic";
            return row;
        }
        ...
        function ViewImage(oper) {
            ...
            viewer_params.dwarfium_mosaic_link = dwarfium_mosaic_link;
