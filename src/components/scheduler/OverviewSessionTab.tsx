  ...
  return (
    <div className="overview-session-container">
      ...
      <div className="overview-session-actions">
        ...
        <button
          onClick={() => setSessionFiles(simulatedFiles)}
          className="overview-session-btn"
        >
          Refresh JSON List
        </button>
      </div>
