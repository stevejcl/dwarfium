...
const translations = {
  ...
  pIndexClaimer:
    "Diese Website und die Dwarf-API befinden sich in der Beta-Phase. Es sind noch nicht alle Funktionen der mobilen App vorhanden. Verwenden Sie diese App nur, wenn Sie sich als Beta-Softwaretester auskennen.",
  pIndexBugsHeader: "Fehler:",
  pIndexBug1: "Hier können Sie Ihre Erkenntnisse einsenden: ",
  pIndexBug2: "",
  pIndexBug3: "",
  pIndexLinkBug: `<a href="https://discord.com/channels/1218255498042937374/1221050885761925150"> Auf unserem Discord-Server </a>`,
  ...
  cDeleteObservationListConfirm: "Möchten Sie wirklich löschen",
  cDeleteObservationListButton: "Liste löschen",
