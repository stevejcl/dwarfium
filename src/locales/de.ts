...
*/
const translations = {
    pIndexDescription: "Diese Website ermöglicht es euch, Teile des Dwarf II mithilfe der Dwarf-API zu steuern.",
    ...
    pIndexClaimer: "Diese Website und die Dwarf-API befinden sich in der Beta-Phase. Die API wurde noch nicht offiziell veröffentlicht, und die API verfügt nicht über alle Funktionen der mobilen App. Daher verfügt diese App über eine sehr begrenzte Liste von Funktionen. Verwenden Sie diese App nur, wenn Sie sich mit dem Testen von Beta-Software wohl fühlen.",
    pIndexBugsHeader: "Fehler:",
    pIndexBug1: "Die interne Datums-URL von Dwarf II funktioniert im Browser aufgrund von CORS nicht (http://DWARF_IP:8092/date?date=).",
    pIndexBug2: "Hierfür wird CORS: Access-Control-Allow-Origin Plugin in Chrome benötigt.",
    pIndexBug3: "Einschränkung: Da diese Website nur den HTTP-Modus zur Kommunikation mit dem DWARF II verwendet, kann sie Ihren Standort nicht erkennen.",
