/*************************************************************************\
 * 
 *      DwarfiumMosaic telescope planner engine. (C) Jarmo Ruuth, 2018-2021
 *
 * An embeddable JavaScript file of DwarfiumMosaic engine. 
 * It can show:
...
/*************************************************************************
 * 
 *      DwarfiumMosaicEngine
 * 
 * DwarfiumMosaic entry point for embedded Javascript.
 * 
 * Notes:
 * - If calling DwarfiumMosaicEngine multiple times Aladin view may show
 *   multiple views. This can be solved by setting DwarfiumMosaicEngine
 ...
 * Example:
 * 
 *  DwarfiumMosaicEngine("horsehead nebula", params, "target-div", "day-div", "year-div");
 */
...
/*************************************************************************
 *
 *      StartDwarfiumMosaicViewerEngine
 * 
    ...
    json_target)
{
    ...
    function drawDayVisibilityandGrid() 
    {
        ...
        if (engine_view_type == "all") {
            ...
            document.getElementById(engine_panels.dayvisibility_panel_text).innerHTML = engine_params.dwarfium_mosaic_link;
        }
    }
    ...
    function drawYearVisibility() 
    {
        ...
        if (engine_view_type != "all" && engine_panels.yearvisibility_panel_text) {
            ...
            document.getElementById(engine_panels.yearvisibility_panel_text).innerHTML = engine_params.dwarfium_mosaic_link;
        }
    }
    ...
    function EngineViewGrid(reposition)
    {
        ...
        if (grid_type == "mosaic") {
            ...
            if (engine_view_type == "all" || engine_view_type == "embedded") {
                ...
                document.getElementById(engine_panels.aladin_panel_text).innerHTML = engine_params.dwarfium_mosaic_link;
            }
        }
        if (engine_view_type == "all") {
