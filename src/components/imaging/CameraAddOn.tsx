...
export default function CameraAddOn(props: PropTypes) {
    ...
    > = async () => {
        ...
        // Change the image source using the ID
        const imgElement = document.getElementById("TakeBurstPhoto") as HTMLImageElement;
        if (imgElement) {
            imgElement.src = "/images/photo-camera-red.png";
        }
        // Reset the image source back to its original source after a delay (3000 milliseconds)
    ...
    > = async () => {
        ...
        // Change the image source using the ID
        const imgElement = document.getElementById("TakeTimeLapse") as HTMLImageElement;
        if (imgElement) {
            imgElement.src = "/images/photo-camera-red.png";
        }
        // Reset the image source back to its original source after a delay (3000 milliseconds)
                        ...
                        <div className="pane">
                            <div className="column">
                                ...
                                <div className="button-container">
                                    <button
                                        className={`button ${activeBtnPhoto === "tele" ? "active" : ""
                                            }`}
                                    ...
                                    <button
                                        className={`button ${activeBtnPhoto === "wide" ? "active" : ""
                                            }`}
                            ...
                            <div className="column">
                                ...
                                <div className="button-container">
                                    <button
                                        className={`button-cent ${activeBtnVideo === "tele" ? "active" : ""
                                            }`}
                            ...
                            <div className="column">
                                ...
                                <div className="button-container">
                                    <button
                                        className={`button-cent ${activeBtnPano === "tele" ? "active" : ""
                                            }`}
                            ...
                            <div className="column">
                                ...
                                <div className="button-container">
                                    <button
                                        className={`button ${activeBtnBurst === "tele" ? "active" : ""
                                            }`}
                                    ...
                                    <button
                                        className={`button ${activeBtnBurst === "wide" ? "active" : ""
                                            }`}
                            ...
                            <div className="column">
                                ...
                                <div className="button-container">
                                    <button
                                        className={`button ${activeBtnTimeLapse === "tele" ? "active" : ""
                                            }`}
                                    ...
                                    <button
                                        className={`button ${activeBtnTimeLapse === "wide" ? "active" : ""
                                            }`}
                            ...
                            <div className="column">
                                ...
                                <div className="button-container">
                                    <button
                                        className={`button-cent ${activeBtnSettings === "wide" ? "active" : ""
                                            }`}
